...
gulp.task("watch", () => {
  ...
  gulp.watch(
    ["./**/*.wxml", "!./node_modules/**", "!./dist/**"],
    gulp.series("templates")
  );
  gulp.watch(
    ["./**/*.wxss", "!./node_modules/**", "!./dist/**"],
    gulp.series("wxss")
  );
  gulp.watch(
    ["./**/*.sass", "!./node_modules/**", "!./dist/**"],
    gulp.series("wxss")
  );
  gulp.watch(
    ["./**/*.scss", "!./node_modules/**", "!./dist/**"],
    gulp.series("wxss")
  );
  gulp.watch(
...
gulp.task("templates", () => {
  return gulp.src("./**/*.wxml").pipe(gulp.dest("./dist"));
});

gulp.task("templatesPro", () => {
  return gulp
    .src(["./**/*.wxml", "!./node_modules/**"])
    .pipe(
      htmlmin({
...
gulp.task("wxss", () => {
  return gulp
    .src(["./**/*.{wxss,scss,sass}", "!./styles/**", "!./node_modules/**"])
    .pipe(sass())
...
gulp.task(
  "build",
  gulp.series(["jsonPro", "assets", "templatesPro", "wxssPro", "scriptsPro"])
);
